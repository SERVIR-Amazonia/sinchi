# 1.Primero vamos a instalar aquellos paquetes o librerías que no hemos 
#instalado previamente
#Usted ya está en la capacidad de seleccionar las librerías que le faltan
...
#las cuales ya debieron ser instaladas en el paso anterior
